    ...
    <div style={styles.body}>
      <div style={styles.card}>
          ...
          {formData.idType && (
            <div style={styles.formGroup}>
              <input
                type="text"
                name="idNumber"
                placeholder={`Enter ${formData.idType === 'aadhaar' ? 'Aadhaar' : formData.idType === 'passport' ? 'Passport' : 'Driving License'} Number`}
        ...
        <div style={styles.footerNote}>
          Prefer Auto registration? <a href="AutoRegister" style={styles.link}>Auto SignUp</a>
        </div>
      </div>
    </div>
  );
